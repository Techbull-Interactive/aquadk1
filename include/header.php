...
<!-- Mirrored from htmlstream.com/preview/unify-v1.8/Shop-UI/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Jan 2016 16:31:19 GMT -->
<head>
    <title>AQUA DK</title>
    ...
    <div class="style-swticher-body">
      ...
      <!--  <div class="style-switcher-heading">Theme Colors</div>
        <ul class="list-unstyled">
            <li class="theme-default" data-style="default" data-header="light"></li>
       ...
       <!-- <div class="style-switcher-heading">Theme Types and Versions</div>
        <div class="row no-col-space margin-bottom-10">
            <div class="col-xs-6">
                <a href="../index-2.html" class="btn-u btn-u-xs btn-u-dark btn-block">Unify Main <small class="dp-block">Template</small></a>
            </div>
            <div class="col-xs-6">
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php">
                        <!--<img id="logo-header" src="assets/img/logo-1.jpeg" alt="Logo">-->
						<p> <span style= "color: black">Aqua DK</span> </p>
                    </a>
                </div>
                        ...
                        <li>
                          ...
                          <!--    <li>
                                    ...
                                    <div class="overflow-h">
                                        <span>MULTI GYM-SM105</span>
                                        <small>1 x ₹30990.00</small>
                                    </div>    
                                </li>
                                <li>
                                    ...
                                    <button type="button" class="close">×</button>
                                    <div class="overflow-h">
                                        <span>MULTI GYM-SM109</span>
                                        <small>1 x ₹32490.00</small>
                                    </div>    
                                </li>
                                <li class="subtotal">
                                    <div class="overflow-h margin-bottom-10">
                                        <span>Subtotal</span>
                                        <span class="pull-right subtotal-cost">₹63480.00</span>
                                    </div>
                                    <div class="row">    
                                        <div class="col-xs-6">
                                            <a href="product-details.php" class="btn-u btn-brd btn-brd-hover btn-u-sea-shop btn-block">View Cart</a>
                                        </div>
                                        <div class="col-xs-6">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                          ...
                          <!--  <ul class="dropdown-menu">
                                <li class="active"><a href="index.php">Shop UI</a></li>
                                <li><a href="product-details.php">Product Page</a></li>
						...
						<li class="dropdown">
						  ...
						  <li class="dropdown">
							...
							<!--<ul class="dropdown-menu">
                                <li class="active"><a href="index.php"> AQUARIUM ACCESSORIES</a></li>
                                <li><a href="product-details.php">AQUARIUM PLANTS</a></li>
                                <li><a href="category.php">FISH</a></li>
                       ...
                       <!-- <li class="dropdown">
                           ...
                           <!-- <ul class="dropdown-menu">
                                <li class="dropdown-submenu">
                                    <a href="javascript:void(0);">Treadmills</a>
                                    <ul class="dropdown-menu">
                                        <li><a href="#">Manual Treadmills</a></li>
                                        <li><a href="#">Basic Treadmills</a></li>
                                        <li><a href="#">Premium Treadmills</a></li>
										<li><a href="#">Commercial Treadmills</a></li>
                                    </ul>    
                                </li>
                                <li class="dropdown-submenu">
                                    <a href="javascript:void(0);">Exercise Bikes</a>
                                    <ul class="dropdown-menu">
                                        <li><a href="#">Spin Bikes</a></li>
                                        </ul>    
                                </li>
								<li class="submenu">
                                    <a href="javascript:void(0);">Elipticals</a>
                               
                                </li>
								<li class="submenu">
                                    <a href="javascript:void(0);">Multi Gym</a>
